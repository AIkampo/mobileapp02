...
class ExaminationListController extends GetxController {
  ...
  removeData() {
    print(
        '(((((((((((((((((((((((( ExaminationListController - initData()  ))))))))))))))))))))))))');
    caseIdList.clear();
...
//依時間排序、分類 檢測清單
  Future<void> sortExaminationList(List examinationList) async {
    ...
    final timestamp7DaysAgo = DateTime.now().add(Duration(days: -7)).millisecondsSinceEpoch;
    final timestamp1MonthAgo = DateTime.now().add(Duration(days: -30)).millisecondsSinceEpoch;
    final timestamp3MonthAgo = DateTime.now().add(Duration(days: -90)).millisecondsSinceEpoch;
