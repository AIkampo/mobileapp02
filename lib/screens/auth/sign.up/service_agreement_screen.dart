...
class _ServiceAgreementScreenState extends State<ServiceAgreementScreen> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: CupertinoButton.filled(
                  child: Text('confirm'.tr), onPressed: () => _nextStep()),
            )
          ],
        ),
      ),
        ...
        content: Container(
          ...
          child: Column(
            children: [
              ...
              //   children: [
              //     IconButton(
              //       onPressed: _agreeServiceAgreement
              //           ? () {
              //               setState(() {
  ...
  void confirmAgreement() async {
    ...
    userDoc.update({
      'agreeServiceAgreement': _agreeServiceAgreement,
  ...
  //       setState(() {
  //         _agreeServiceAgreement = data['agreeServiceAgreement'];
  //       });
  //     },
  //   );
  // }`
