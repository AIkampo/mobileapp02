...
class _MyPointsScreenState extends State<MyPointsScreen> {
  final List dataList = [
    ...
    {"screen": () => PresentScreen(), "title": "點數贈送", "icon": CupertinoIcons.gift},
    {"screen": null, "title": "商城", "icon": Icons.storefront},
    {"screen": () => InvitationScreen(), "title": "邀請朋友", "icon": CupertinoIcons.mail},
  ];
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              decoration: BoxDecoration(
                  shape: BoxShape.circle, border: Border.all(color: Colors.amber, width: 12)),
              child: Column(
                ...
                child: ListTile(
                  ...
                  trailing: dataList[index]['screen'] == null
                      ? FittedBox(
                          fit: BoxFit.fill,
                          child: Row(
                            children: const [Icon(Icons.construction), Text(" 建置中…")],
                          ),
                        )
