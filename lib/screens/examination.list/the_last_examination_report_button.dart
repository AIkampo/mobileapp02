...
class TheLastExaminationReportButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isExaminationDataLoading.value
        ? Container(
        ...
        : InkWell(
            onTap: () {
              Get.to(() => ExaminationReportScreen(),
                  arguments: {"caseId": _controller.theLastCaseId.value});
            },
            child: Container(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                              "檢測日期：${caseIdToDatetime(_controller.theLastCaseId.toString())}")
                        ],
                      ),
