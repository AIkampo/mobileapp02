                  ...
                  onTap: () {
                    _examinationReportController.fetchOrganSystemData(
                        _examinationReportController
                            .nineSystemList[index].indexName!,
                        _examinationReportController.reportCaseId.value);
                    Get.to(
                      () => SystemReportScreen(),
                      arguments: {
                        "organData": _examinationReportController
                                .nineSystemList[index] ??
                            ""
                      },
                    );
                  },
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(
                                  width: 42,
                                  height: 42,
                                  image: AssetImage(_examinationReportController
                                      .nineSystemList[index].img!)),
                            ),
                            Column(
                              children: [
                                Text(
