...
class ReportProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
        " ****************  _examinationListController :${_examinationListController.userProfile['username']}");
    return Row(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      _examinationListController.userProfile['sex'] == "M"
                          ? Icon(
                              Icons.man,
                              color: Colors.blue,
                            )
                      ...
                      Text(
                        _examinationListController.userProfile['username'],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${UserProfile.bloodTypeList[int.parse(_examinationListController.userProfile['bloodType'])]}型',
                        style: TextStyle(fontSize: 18),
                      ),
                      SizedBox(
                        width: 10,
                      ...
                      Text(
                        DateFormat("yyyy/MM/dd").format(
                            _examinationListController.userProfile['birthday']
                                .toDate()),
                        style: TextStyle(fontSize: 18),
                      ),
                    ],
