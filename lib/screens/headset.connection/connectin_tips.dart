...
class ConnectionTips extends StatelessWidget {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //       style: TextStyle(fontSize: 20),
                //     ),
                //     subtitle: _isLocationEnable.value
                //         ? Text(
                //             "已開啟",
                ...
                //             style: TextStyle(color: Colors.red),
                //           ),
                //     trailing: _isLocationEnable.value
                //         ? null
                //         : CupertinoButton(
                //             onPressed: () => turnOnLoacationService(),
  ...
  checkLoaction() async {
    print("***********checkLoaction:${await _location.serviceEnabled()}");
    _isLocationEnable.value = await _location.serviceEnabled();
  }

  turnOnLoacationService() async {
    await _location.serviceEnabled().then((value) async {
      _isLocationEnable.value = await _location.serviceEnabled();
    }).catchError(() => Get.snackbar("注意！", "無法開啟位置資訊"));
  }
}
