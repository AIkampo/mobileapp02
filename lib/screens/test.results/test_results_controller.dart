...
class TestResultsController extends GetxController {
  ...
  //器官系統分析資料
  var organSystemList = <ScoreModel>[].obs;
  ...
  Future<void> fetchOrganSystemData(String organ) async {
    print("*********organ:$organ");
    try {
      final response = await Dio().get(
        "https://www.oberonhc.com/api/Score/cycle/7/1668931826224",
        options: Options(headers: _headers),
      );
